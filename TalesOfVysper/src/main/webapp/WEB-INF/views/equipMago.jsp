...
<video autoplay muted loop id="background-video">
  <source src="images/magebg2.webm" type="video/mp4">
  Your browser does not support HTML5 video.
</video>
<form:form method="post" modelAttribute="mago" action="/TalesOfVysper/addEquipMago">
<table>
		<tr>
		...
		<form:hidden path="id" />
          <form:hidden path="nome" />
         	...
         	<select name="id_arma" id= "id_arma">
				...
				<option value="5" class="titolo">Saggezza+5</option>
				<option value="6" class="titolo">Livello+1</option>
			</select>
			</form:label></td>
         	<td class="GFG"><form:label path="id_armatura">Armatura
         	<select name="id_armatura" id= "id_armatura">
         		<option value="0">--SELEZIONA--</option>
				<option value="5" class="titolo">Difesa+4</option>
				<option value="6" class="titolo">Hp+50</option>
			</select>
			</form:label></td>
