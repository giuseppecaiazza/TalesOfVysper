...
.button {
    background-color: rgb(0, 102, 255,0.8);
    border: none;
    color: black;
    padding: 15px 32px;
    text-align: center;
...
<video autoplay muted loop id="background-video">
  <source src="images/area2.mp4" type="video/mp4">
  Your browser does not support HTML5 video.
</video>
<h3 class="GFG">STONELAND</h3>
<c:if test="${!empty message2}">
<div class="center">
<img src="images/golem_avatar.gif" class="animated-gif"/>
<h3 class="GFG2">Hai incotrato un golem!</h3>
	<form:form method="post" modelAttribute="listeroe" action="/TalesOfVysper/combattiarea2">
		<tr>
		<form:hidden path="id"/>
...
<img src="images/mortegolem.gif" class="animated-gif"/>
